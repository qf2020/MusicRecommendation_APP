...
public class ItemGroupView extends FrameLayout{
    ...
    public ItemGroupView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
        initAttrs(context, attrs);
    }

    public ItemGroupView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private void initView(Context context) {
        ...
        titleTv = (TextView) view.findViewById(R.id.item_group_title_text);
        contentEdt = (TextView) view.findViewById(R.id.item_group_content_text);
        jtRightIv = (ImageView) view.findViewById(R.id.item_group_right_iv);
