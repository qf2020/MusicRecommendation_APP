...
import cjk.design.music.databinding.ActivityNewMusicSecondBinding;
...
public class NewMusicSecondActivity extends AppCompatActivity {

    private static final String TAG = "MainActivity";
    private ActivityNewMusicSecondBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(getResources().getColor(R.color.new2));

        super.onCreate(savedInstanceState);
        binding = ActivityNewMusicSecondBinding.inflate(getLayoutInflater());
    ...
    private void initDate(){
        HttpClient.getNewMusic("96",new HttpCallback<NewMusicBean>() {
            @Override
    ...
    private void initView() {
        ...
        setSupportActionBar(binding.newSecondTb); //获取actionbar
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);//显示返回按钮

        SpannableString sStr = new SpannableString("度假无极限!"+'\n'+"  假期氛围.");
        sStr.setSpan(new AbsoluteSizeSpan(25, true),6,sStr.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        binding.newSecondCollapsingToolbar.setTitle(sStr);

        adapter = new MusicRecycleAdapter(this,list,2);
        adapter.setOnItemListener(new MusicRecycleAdapter.ItemListener() {
            @Override
            public void ItemOnClick(int position) {
                new PlaySearchedMusic(NewMusicSecondActivity.this, list.get(position)) {
                    @Override
                    ...
                    public void onExecuteSuccess(Music music) {
                        ...
                        Intent intent = new Intent(NewMusicSecondActivity.this, MusicPlayActivity.class);
        ...
        binding.newSecondRecycle.setLayoutManager(manager);
        binding.newSecondRecycle.setAdapter(adapter);
