...
public class RecommendationSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(getResources().getColor(R.color.base2));
    ...
    private void initDate(){
        HttpClient.getPlayListDetail("101354498", new HttpCallback<PlaylistDetailBean>() {
            @Override
    ...
    private void initView() {
        ...
        adapter.setOnItemListener(new MusicRecycleAdapter.ItemListener() {
            ...
            public void ItemOnClick(int position) {
                new PlaySearchedMusic(RecommendationSecondActivity.this, list.get(position)) {
                    @Override
