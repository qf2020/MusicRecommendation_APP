...
public class NestedScrollingParent2PlayListLayout extends LinearLayout implements NestedScrollingParent2 {
    ...
    public NestedScrollingParent2PlayListLayout(Context context) {
        this(context, null);
    }

    public NestedScrollingParent2PlayListLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestedScrollingParent2PlayListLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        lp.height = (int) (getMeasuredHeight() - mNavView.getMeasuredHeight()- getResources().getDimension(R.dimen.play_list_height2));
        //这里减去105是因为topview往上多占了5dp,然后NestedScrollingParent2PlayListLayout自己paddingTop了100dp
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mCanScrollDistance = mTopView.getMeasuredHeight()+ getResources().getDimension(R.dimen.play_list_height1);
