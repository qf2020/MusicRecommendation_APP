...
public class NewMusicFirstActivity extends AppCompatActivity {


    private static final String TAG = "MainActivity";
    private ActivityNewMusicFirstBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(getResources().getColor(R.color.new1));
        //标题折叠状态下，无法设置
        // maxlines。（目前来看改不了了）
        //未完成数据填充和界面按键响应事件
        super.onCreate(savedInstanceState);
        binding = ActivityNewMusicFirstBinding.inflate(getLayoutInflater());
    ...
    private void initDate(){
        HttpClient.getNewMusic("8",new HttpCallback<NewMusicBean>() {
            @Override
    ...
    private void initView() {
            ...
            public void ItemOnClick(int position) {
                new PlaySearchedMusic(NewMusicFirstActivity.this, list.get(position)) {
                    ...
                    public void onExecuteSuccess(Music music) {
                        ...
                        Intent intent = new Intent(NewMusicFirstActivity.this, MusicPlayActivity.class);
        ...
        binding.newFirstRecycle.setLayoutManager(manager);
        binding.newFirstRecycle.setAdapter(adapter);
