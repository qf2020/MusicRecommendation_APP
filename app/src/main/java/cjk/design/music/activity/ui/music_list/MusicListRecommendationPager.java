 ...
 * 歌单广场的3个推荐歌单的Pager
 */
public class MusicListRecommendationPager extends ViewGroup {
    private static final String TAG = "MusicListRecommendationPager";
    ...
    public MusicListRecommendationPager(Context context) {
        this(context, null);
    }

    public MusicListRecommendationPager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MusicListRecommendationPager(Context context, AttributeSet attrs, int defStyleAttr) {
