...
public class ItemNameEdit extends FrameLayout{
    ...
    public ItemNameEdit(@NonNull Context context) {
        super(context);
        initView(context);
    }

    public ItemNameEdit(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
        initAttrs(context, attrs);
    }

    public ItemNameEdit(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.name_edit_layout, null);
